      ...
      <form id="createAccountForm" onSubmit={onSubmit}>
        ...
        <div className="form-group mt-3">
          ...
          <small id="passwordDetail">
            At least 8 characters using alphanumeric and special characters
          </small>
        </div>
        <div className="form-group mt-3">
          ...
          <div className="d-flex form-row">
            ...
            <div className="d-flex col-1 align-items-center">
              {hasMatchingPasswords && passwordBis ? (
                <CheckCircleIcon className="green" fontSize="small" />
              ) : (
                <CancelIcon className="red" fontSize="small" />
              )}
        ...
        <div className="form-group mt-4">
          <small className="gray">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut a felis
            id nisl tempus bibendum quis et purus. Morbi sem lacus, volutpat a
            vulputate id, tempor et elit.
          </small>
        </div>
      </form>
    </>
