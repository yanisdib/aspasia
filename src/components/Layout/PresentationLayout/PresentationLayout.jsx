      ...
      <div className="row app-detail justify-content-between mtb-3">
        {isReversed ? (
          <>
            ...
            <div
              className="d-none d-sm-none d-md-flex d-lg-flex d-xl-flex col-md-5 col-lg-6 col-xl-5 h-8"
              style={backgrounds[1]}
            ></div>
            <div className="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 offset-md-1 offset-lg-1 offset-xl-1 h-100">
              <div className="row h-4 justify-content-end">
                <div className="col-10 col-sm-11 col-md-12 col-lg-10 col-xl-9 p-0 align-self-center text-right">
              ...
              <div className="row h-6">
                <div
                  className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 align-self-end h-100"
                  style={backgrounds[0]}
                ></div>
          ...
          <>
            <div className="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 h-100">
              <div className="row h-4">
                <div className="col-10 col-sm-11 col-md-12 col-lg-10 col-xl-9 p-0 align-self-center">
                  <h2 className="fw-6">{title}</h2>
            ...
            <div
              className="d-none d-sm-none d-md-flex d-lg-flex d-xl-flex col-md-5 col-lg-6 col-xl-5 h-8 offset-md-1 offset-lg-1 offset-xl-1"
              style={backgrounds[1]}
            ></div>
